...
SLATER_REELS_LIMA_RAMOS_BARET_OVERRIDES = {'scott-a-slater': {'report_label': 'Q2 2026 campaign finance filing',
                    'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                    'source_note': "Built from Scott A Slater's Rhode Island Q1 and Q2 2026 campaign finance filings "
                                   'supplied by the user.',
                    'coverage_note': 'Detailed Q1/Q2 filing data; Q2 is the standardized main display.',
                    'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                            'period': 'January 1, 2026 to March 31, 2026',
                                            'href': '/data/finance-documents/scott-a-slater-q1-2026.pdf'},
                                           {'label': 'Q2 2026 CF-2 report',
                                            'period': 'April 1, 2026 to June 30, 2026',
                                            'href': '/data/finance-documents/scott-a-slater-q2-2026.pdf'}],
                    'beginning_cash': 68217.13,
                    'money_raised': 45350.0,
                    'money_spent': 16061.17,
                    'ending_cash': 97505.96,
                    'net_change': 29288.83,
                    'total_cash_receipts': 45350.0,
                    'campaign_expenses': 16061.17,
                    'aggregate_expenses': 0.0,
                    'summary_intro': "Scott A Slater's Q2 2026 filing reports $45,350.00 in receipts, $16,061.17 in "
                                     'campaign expenses, and $97,505.96 in cash on hand.',
                    'filing_history': [{'label': 'Q1 2026',
                                        'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                        'money_raised': 1000.0,
                                        'money_spent': 3325.62,
                                        'ending_cash': 68217.13,
                                        'net_change': -2325.62,
                                        'notes': 'Q1 retained in filing history.'},
                                       {'label': 'Q2 2026',
                                        'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                    ...
                    'top_donors': [{'donor': 'Gerard C. DiSanto II',
                                    ...
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Club Desire.'},
                                   {'donor': 'Peter M. Kasabian Jr.',
                                    'amount': 2000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Donovan Obair, LLC.'},
                                   {'donor': 'Ralph A. Palumbo',
                                    'amount': 2000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Ralph A. Palumbo, CPA.'},
                                   {'donor': 'Thomas E. Badway',
                                    'amount': 2000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Thomas E. Badway & Associates.'},
                                   {'donor': 'Diane Palumbo',
                                    'amount': 1000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Southern Sky Renewable Energy.'},
                                   {'donor': 'John H. Petrarca',
                                    'amount': 1000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                   ...
                                   {'donor': 'Simon Chan',
                                    ...
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Islander Restaurant.'},
                                   {'donor': 'Jacob Bissaillon',
                                    'amount': 925.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as State of Rhode Island.'},
                                   {'donor': 'Armand T. Lusi',
                                    ...
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as A.F. Lusi Construction, Inc.'},
                                   {'donor': 'Laurence K. Flynn',
                                    'amount': 625.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as retired.'}],
                    'spending_categories': [{'title': 'Fundraising Expenses',
                                             'summary': 'Visible spending includes Capriccio, City of Providence, and '
                                                        'Millonzi Fine Catering.',
                                             'amount': 7450.59},
                                            {'title': 'Donations (All Others)',
                                             'summary': 'Visible spending includes Blood Cancer United, CVS, and '
                                                        'Dominican Independence Heritage Award Committee.',
                                             'amount': 3317.5},
                                            {'title': 'Office Equipment & Supplies',
                                             'summary': 'Visible spending includes Best Buy and Sani Creative.',
                                             'amount': 1689.67},
                                            {'title': 'Food, Beverages and Meals',
                                             'summary': "Visible spending includes Camille's Restaurant, Capital "
                                                        'Grille, and Capriccio.',
                                             'amount': 1366.04},
                                            {'title': 'Travel & Lodging',
                                             'summary': 'Visible spending includes American Airlines, Hyatt Arlington, '
                                                        'and Rosslyn Metro Station.',
                                             'amount': 930.43},
                                            {'title': 'Donations (Political)',
                                             'summary': 'Visible spending includes Committee to Elect Edith Ajello, '
                                                        'Friends of Michael Solomon, and Friends of Oscar Vargas.',
                                             'amount': 900.0},
                                            {'title': 'Bank Fees',
                                             'summary': 'Visible spending includes ActBlue and Citizens Bank.',
                                             'amount': 206.94},
                                            {'title': 'Consultant & Professional Services',
                                             'summary': 'Visible spending includes Erasmo Ramirez.',
                                             'amount': 200.0}],
                    'takeaways': [],
                    'explainer_cards': [],
                    'finance_status': 'available'},
 'derick-a-reels': {'report_label': 'No financial summary details found',
                    'reporting_period_label': '',
                    'source_note': 'No financial summary details were available in the source material supplied for '
                                   'this update.',
                    'coverage_note': 'No financial summary details found. Zeroes should not be interpreted as reported '
                    ...
                    'ending_cash': None,
                    'net_change': None,
                    'total_cash_receipts': None,
                    'campaign_expenses': None,
                    'aggregate_expenses': None,
                    'summary_intro': 'No financial summary details found.',
                    'filing_history': [],
                    'source_buckets': [],
                    'top_donors': [],
                    'spending_categories': [],
                    'takeaways': [],
                    'explainer_cards': [],
                    'finance_status': 'not_found'},
 'charlene-m-lima': {'report_label': 'Q2 2026 campaign finance filing',
                     'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                     'source_note': "Built from Charlene Lima's Rhode Island Q1 and Q2 2026 campaign finance filings "
                                    'supplied by the user.',
                     'coverage_note': 'Detailed Q1/Q2 filing data; Q2 is the standardized main display. Q2 contains '
                                      'both itemized and aggregate receipts.',
                     'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                             'period': 'January 1, 2026 to March 31, 2026',
                                             'href': '/data/finance-documents/charlene-lima-q1-2026.pdf'},
                                            {'label': 'Q2 2026 CF-2 report',
                                             'period': 'April 1, 2026 to June 30, 2026',
                                             'href': '/data/finance-documents/charlene-lima-q2-2026.pdf'}],
                     'beginning_cash': 96517.26,
                     'money_raised': 11210.0,
                     'money_spent': 2624.35,
                     'ending_cash': 105102.91,
                     'net_change': 8585.65,
                     'total_cash_receipts': 11210.0,
                     'campaign_expenses': 851.17,
                     'aggregate_expenses': 1773.18,
                     'summary_intro': "Charlene M Lima's Q2 2026 filing reports $11,210.00 in cash receipts, $2,624.35 "
                                      'in total spending, and $105,102.91 in cash on hand. The filing also reports '
                                      '$500.00 in in-kind support.',
                     'filing_history': [{'label': 'Q1 2026',
                                         'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                         'money_raised': 0.0,
                                         'money_spent': 1819.62,
                                         'ending_cash': 96517.26,
                                         'net_change': -1819.62,
                                         'notes': 'Q1 reported no cash receipts.'},
                                        {'label': 'Q2 2026',
                                         'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                         'money_raised': 11210.0,
                                         'money_spent': 2624.35,
                     ...
                     'source_buckets': [{'label': 'Itemized individual donors',
                                         'class_name': 'itemized-individual-donors',
                                         'amount': 4550.0,
                                         'description': 'Named individual cash contributions reported in Q2.'},
                                        {'label': 'Receipts without donor names listed',
                                         'class_name': 'small-dollar-aggregate-online-receipts',
                                         'amount': 3385.0,
                                         'description': 'Aggregate individual cash receipts reported without donor '
                                                        'names.'},
                                        {'label': 'PAC contributions',
                                         'class_name': 'pac-contributions',
                                         'amount': 2250.0,
                                         'description': 'Total PAC cash contributions reported in Q2.'},
                                        {'label': 'PAC receipts without committee names listed',
                                         'class_name': 'pac-contributions',
                                         'amount': 1025.0,
                                         'description': 'Aggregate PAC receipts included within the Q2 PAC total.'}],
                     'top_donors': [{'donor': 'Adam Sepe',
                                     'amount': 1000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Northeast Tree.'},
                                    {'donor': 'Louis Gellis',
                                     'amount': 1000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Fusing Home Independent.'},
                                    {'donor': 'RI HEALTH CARE ASSOCIATION PAC',
                                     'amount': 1000.0,
                                     'type': 'PAC',
                                     'interest_group': 'Health Care',
                                     'notes': 'Named contribution listed in the filing.'},
                                    {'donor': 'Sandra Petraca',
                                     'amount': 1000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Providence Auto Body.'},
                                    {'donor': 'Andy Andujar',
                                     ...
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'A $500 in-kind individual contribution is also reported for one-half of '
                                              'a fundraiser food expense.'},
                                    {'donor': 'INTERNATIONAL BROTHERHOOD OF POLICE OFFICERS LOCAL 301',
                                     'amount': 500.0,
                                     'type': 'PAC',
                                     'interest_group': 'Public Safety',
                                     'notes': 'Named contribution listed in the filing.'},
                                    {'donor': 'Joseph Walsh',
                                     ...
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Government Strategies Inc.'},
                                    {'donor': 'Anthony Victoria',
                                     'amount': 300.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Auto Service Autobody.'}],
                     'spending_categories': [{'title': 'Fundraising Expenses',
                                              'summary': 'Visible itemized spending includes Regine Printing.',
                                              'amount': 851.17},
                                             {'title': 'Food, Beverages and Meals',
                                              'summary': 'Aggregate food-and-beverage expenses reported in the filing.',
                                              'amount': 845.77},
                                             {'title': 'Donations (All Others)',
                                              'summary': 'Aggregate donations and gifts reported in the filing.',
                                              'amount': 543.94},
                                             {'title': 'Office Equipment & Supplies',
                                              'summary': 'Aggregate newspaper and online-technology expenses reported '
                                                         'in the filing.',
                                              'amount': 383.47}],
                     'takeaways': [],
                     'explainer_cards': [],
                     'finance_status': 'available'},
 'kassielle-m-ramos': {'report_label': 'No financial summary details found',
                       'reporting_period_label': '',
                       'source_note': 'No financial summary details were available in the source material supplied for '
                                      'this update.',
                       'coverage_note': 'No financial summary details found. Zeroes should not be interpreted as '
                       ...
                       'explainer_cards': [],
                       'finance_status': 'not_found'},
 'naiommi-baret': {'report_label': '28 Days Before Primary filing',
                   'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                   'source_note': "Built from Naiommi Baret's Rhode Island 28 Days Before Primary campaign finance "
                                  'filing supplied by the user.',
                   'coverage_note': 'This is a 28 Days Before Primary filing, not a Q2 quarterly report, so its '
                                    'reporting period is not directly comparable with candidates whose main display is '
                                    'Q2 2026.',
                   'original_documents': [{'label': '28 Days Before Primary 2026 CF-2 report',
                                           'period': 'June 22, 2026 to August 11, 2026',
                                           'href': '/data/finance-documents/naiommi-baret-28-days-before-primary-2026.pdf'}],
                   'beginning_cash': 0.0,
                   'money_raised': 1675.0,
                   'money_spent': 1461.45,
                   'ending_cash': 213.55,
                   'net_change': 213.55,
                   'total_cash_receipts': 1675.0,
                   'campaign_expenses': 1461.45,
                   'aggregate_expenses': 0.0,
                   'summary_intro': "Naiommi Baret's 28 Days Before Primary filing reports $1,675.00 in cash receipts, "
                                    '$1,461.45 in campaign expenses, and $213.55 in cash on hand. The filing also '
                                    'reports $418.00 in in-kind support.',
                   'filing_history': [{'label': '28 Days Before Primary 2026',
                                       'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                                       'money_raised': 1675.0,
                                       'money_spent': 1461.45,
                                       'ending_cash': 213.55,
                                       'net_change': 213.55,
                                       'notes': 'Pre-primary filing; not directly comparable with Q2 quarterly '
                                                'reports.'}],
                   'source_buckets': [{'label': 'Itemized individual donors',
                                       'class_name': 'itemized-individual-donors',
                                       'amount': 1100.0,
                                       'description': 'Named individual cash contributions reported in the pre-primary '
                                                      'filing.'},
                                      {'label': 'Receipts without donor names listed',
                                       'class_name': 'small-dollar-aggregate-online-receipts',
                                       'amount': 575.0,
                                       'description': 'Aggregate individual cash receipts reported without donor '
                                                      'names.'}],
                   'top_donors': [{'donor': 'Carol Aguasvivas',
                                   'amount': 650.0,
                                   'type': 'Individual',
                                   'interest_group': 'Individual',
                                   'notes': 'Employer listed as RI Collective for Education.'},
                                  {'donor': 'Jole Ramirez',
                                   'amount': 618.0,
                                   'type': 'Individual',
                                   'interest_group': 'Individual',
                                   'notes': '$200 cash contribution plus $418 in-kind contribution for fundraiser '
                                            'food; employer listed as La Roca Restaurant.'},
                                  {'donor': 'Thomas Weyman',
                                   'amount': 250.0,
                                   'type': 'Individual',
                                   'interest_group': 'Individual',
                                   'notes': 'Employer listed as Columbus Cooperative.'}],
                   'spending_categories': [{'title': 'Consultant & Professional Services',
                                            'summary': 'Visible spending includes All The Answers.',
                                            'amount': 1070.77},
                                           {'title': 'Fundraising Expenses',
                                            'summary': 'Visible spending includes La Eskina.',
                                            'amount': 350.48},
                                           {'title': 'Bank Fees',
                                            'summary': 'Visible spending includes Stripe Inc.',
                                            'amount': 40.2}],
                   'takeaways': [],
                   'explainer_cards': [],
                   'finance_status': 'available_preprimary'}}


def apply_slater_reels_lima_ramos_baret_overrides(profile: dict[str, object]) -> dict[str, object]:
    override = SLATER_REELS_LIMA_RAMOS_BARET_OVERRIDES.get(str(profile.get("slug", "")))
    if not override:
        return profile
    profile.update(override)
    return profile
...
PAPLAUSKAS_CRUDELE_SEGUI_OVERRIDES = {'christopher-g-paplauskas': {'report_label': 'Q2 2026 campaign finance filing',
                              'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                              'source_note': "Built from Christopher G Paplauskas's Rhode Island Q1 and Q2 2026 "
                                             'campaign finance filings supplied by the user.',
                              'coverage_note': 'Detailed Q1/Q2 filing data; Q2 is the standardized main display.',
                              'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                                      'period': 'January 1, 2026 to March 31, 2026',
                                                      'href': '/data/finance-documents/christopher-g-paplauskas-q1-2026.pdf'},
                                                     {'label': 'Q2 2026 CF-2 report',
                                                      'period': 'April 1, 2026 to June 30, 2026',
                                                      'href': '/data/finance-documents/christopher-g-paplauskas-q2-2026.pdf'}],
                              'beginning_cash': 22270.85,
                              'money_raised': 12440.0,
                              'money_spent': 6396.15,
                              'ending_cash': 28314.7,
                              'net_change': 6043.85,
                              'total_cash_receipts': 12440.0,
                              'campaign_expenses': 6396.15,
                              'aggregate_expenses': 0.0,
                              'summary_intro': "Christopher G Paplauskas's Q2 2026 filing reports $12,440.00 in "
                                               'receipts, $6,396.15 in campaign expenses, and $28,314.70 in cash on '
                                               'hand.',
                              'filing_history': [{'label': 'Q1 2026',
                                                  'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                                  'money_raised': 5050.0,
                                                  'money_spent': 2184.35,
                                                  'ending_cash': 22270.85,
                                                  'net_change': 2865.65,
                                                  'notes': 'Q1 retained in filing history.'},
                                                 {'label': 'Q2 2026',
                                                  'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                              ...
                              'source_buckets': [{'label': 'Itemized individual donors',
                                                  'class_name': 'itemized-individual-donors',
                                                  'amount': 9540.0,
                                                  'description': 'Individual contributions reported in Q2.'},
                                                 {'label': 'PAC contributions',
                                                  'class_name': 'pac-contributions',
                                                  'amount': 2900.0,
                                                  'description': 'Political action committee contributions reported in '
                                                                 'Q2.'}],
                              'top_donors': [{'donor': 'INTERNATIONAL BROTHERHOOD OF POLICE OFFICERS LOCAL 301',
                                              'amount': 2000.0,
                                              'type': 'PAC',
                                              'interest_group': 'Public Safety',
                                              'notes': 'Named contribution listed in the filing.'},
                                             {'donor': 'Friends of Ken Hopkins',
                                              'amount': 2000.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Reported as an individual contribution in the filing, despite '
                                                       'the committee-style name.'},
                                             {'donor': 'James Donahue',
                                              'amount': 1000.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Employer listed as Old Sturbridge Village.'},
                                             {'donor': 'John H Petrarca',
                                              'amount': 1000.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                             ...
                                             {'donor': 'Alan Muoio',
                                              ...
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Employer listed as Lawn Beauticians Inc.'},
                                             {'donor': 'CRANSTON FIREFIGHTERS LOCAL 1363 COPE',
                                              'amount': 500.0,
                                              'type': 'PAC',
                                              'interest_group': 'Public Safety',
                                              'notes': 'Named contribution listed in the filing.'},
                                             {'donor': 'James Pagliarini',
                                              'amount': 500.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Employer listed as Central Nursery.'},
                                             {'donor': 'Rusell Henry III',
                                              'amount': 500.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Employer listed as City of Cranston.'},
                                             {'donor': 'Denise Paplauskas',
                                              'amount': 300.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Employer listed as retired.'},
                                             {'donor': "RI LABORERS' PAC",
                                              ...
                                              'interest_group': 'Labor / Unions',
                                              'notes': 'Named contribution listed in the filing.'},
                                             {'donor': 'RHODE ISLAND ENERGY PAC (RIE PAC)',
                                              'amount': 100.0,
                                              'type': 'PAC',
                                              'interest_group': 'Energy / Utilities',
                                              'notes': 'Named contribution listed in the filing.'},
                                             {'donor': 'RI STATE LODGE FOP PAC (Fraternal Order of Police)',
                                              'amount': 100.0,
                                              'type': 'PAC',
                                              'interest_group': 'Public Safety',
                                              'notes': 'Named contribution listed in the filing.'}],
                              'spending_categories': [{'title': 'Food, Beverages and Meals',
                                                       'summary': 'Visible spending includes Bajas, Bar Lazio, Circe '
                                                                  'Prime, Harukis, Legal Sea Foods, The Capital '
                                                                  'Grille, The Thirsty Beaver, and Twin Oaks.',
                                                       'amount': 1479.05},
                                                      {'title': 'Fundraising Expenses',
                                                       'summary': 'Visible spending includes Revolution American '
                                                                  'Bistro and Rhode Island Yacht Club.',
                                                       'amount': 1331.4},
                                                      {'title': 'Donations (Political)',
                                                       'summary': 'Visible spending includes Cranston Republican City '
                                                                  'Committee and Friends of Anthony Melillo.',
                                                       'amount': 1200.0},
                                                      {'title': 'Travel & Lodging',
                                                       'summary': 'Visible spending includes AC Hotel, Lyft, and Uber '
                                                                  'for a Community Leaders of America conference.',
                                                       'amount': 708.13},
                                                      {'title': 'Donations (All Others)',
                                                       'summary': 'Visible spending includes Cranston Historical '
                                                                  "Society, Edgewood Garden Club, Lowe's, and Western "
                                                                  'Cranston Garden Club.',
                                                       'amount': 677.57},
                                                      {'title': 'Advertising',
                                                       'summary': 'Visible spending includes Cranston East Little '
                                                                  'League, Cranston Hall of Fame, and Cranston West '
                                                                  'Little League.',
                                                       'amount': 650.0},
                                                      {'title': 'Consultant & Professional Services',
                                                       'summary': 'Visible spending includes Joseph F Agresti.',
                                                       'amount': 350.0}],
                              'takeaways': [],
                              'explainer_cards': [],
                              'finance_status': 'available'},
 'colleen-m-crudele': {'report_label': 'No financial summary details found',
                       'reporting_period_label': '',
                       'source_note': 'No financial summary details were available in the source material supplied for '
                                      'this update.',
                       'coverage_note': 'No financial summary details found. Zeroes should not be interpreted as '
                       ...
                       'explainer_cards': [],
                       'finance_status': 'not_found'},
 'janie-lee-segui': {'report_label': '28 Days Before Primary filing',
                     'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                     'source_note': "Built from Janie Lee Segui's Rhode Island 28 Days Before Primary campaign finance "
                                    'filing supplied by the user.',
                     'coverage_note': 'This is a 28 Days Before Primary filing rather than a Q2 quarterly filing, so '
                                      'it is not directly comparable with candidates whose main display covers April 1 '
                                      'through June 30.',
                     'original_documents': [{'label': '28 Days Before Primary 2026 CF-2 report',
                                             'period': 'June 22, 2026 to August 11, 2026',
                                             'href': '/data/finance-documents/janie-lee-segui-28-days-before-primary-2026.pdf'}],
                     'beginning_cash': 0.0,
                     'money_raised': 7985.0,
                     'money_spent': 2391.61,
                     'ending_cash': 5593.39,
                     'net_change': 5593.39,
                     'total_cash_receipts': 7985.0,
                     'campaign_expenses': 2391.61,
                     'aggregate_expenses': 0.0,
                     'summary_intro': "Janie Lee Segui's 28 Days Before Primary filing reports $7,985.00 in total cash "
                                      'received, including a $10.00 loan used to open the bank account, $2,391.61 in '
                                      'campaign expenses, and $5,593.39 in cash on hand. The filing also reports '
                                      '$1,000.00 in in-kind support.',
                     'filing_history': [{'label': '28 Days Before Primary 2026',
                                         'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                                         'money_raised': 7985.0,
                                         'money_spent': 2391.61,
                     ...
                     'source_buckets': [{'label': 'Itemized individual donors',
                                         'class_name': 'itemized-individual-donors',
                                         'amount': 6850.0,
                                         'description': 'Named individual cash contributions reported in the '
                                                        'pre-primary filing.'},
                                        {'label': 'Receipts without donor names listed',
                                         'class_name': 'small-dollar-aggregate-online-receipts',
                                         'amount': 1125.0,
                                        ...
                                        {'label': 'Candidate loan',
                                         'class_name': 'candidate-loan',
                                         'amount': 10.0,
                                         'description': 'Loan proceeds from Janie Lee Segui used to open the bank '
                                                        'account.'}],
                     'top_donors': [{'donor': 'James Kingston',
                                     'amount': 2000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as not employed.'},
                                    {'donor': 'Kevin Gallagher',
                                     'amount': 2000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as consultant.'},
                                    {'donor': 'Jessie Kingston',
                                     'amount': 1000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as not employed.'},
                                    {'donor': 'Jonathon Acosta',
                                     'amount': 1000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'In-kind contribution; employer listed as Postdoctoral Research '
                                              'Associate / State Senator at State of Rhode Island.'},
                                    {'donor': 'Keri Langan',
                                     'amount': 500.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as National Parents Union.'},
                                    {'donor': 'Victoria Criado',
                                     'amount': 350.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as PLT Strategies Group.'},
                                    {'donor': 'Brennan McMahon',
                                     'amount': 250.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Data Quality Campaign.'},
                                    {'donor': 'Chiara Deltito-Sharrott',
                                     'amount': 250.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as RICPSL.'},
                                    {'donor': 'Jessica Coyle',
                                     'amount': 250.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as URI.'},
                                    {'donor': 'Margery Yeager',
                                     'amount': 250.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as Education Forward DC.'}],
                     'spending_categories': [{'title': 'Other',
                                              'summary': 'Visible spending includes RI Democratic Party for VAN.',
                                              'amount': 1750.0},
                                             {'title': 'Consultant & Professional Services',
                                              'summary': 'Visible spending includes She Moves Foward for graphic '
                                                         'design and website work.',
                                              'amount': 300.0},
                                             {'title': 'Food, Beverages and Meals',
                                              'summary': 'Visible spending includes Samms Inn.',
                                              'amount': 221.98},
                                             {'title': 'Bank Fees',
                                              'summary': 'Visible spending includes ActBlue.',
                                              'amount': 119.63}],
...
def apply_paplauskas_crudele_segui_overrides(profile: dict[str, object]) -> dict[str, object]:
    override = PAPLAUSKAS_CRUDELE_SEGUI_OVERRIDES.get(str(profile.get("slug", "")))
    if not override:
        return profile
    profile.update(override)
    return profile
...
PEREIRA_COBURN_ROBERTS_SHEEHAN_OVERRIDES = {'zakary-j-pereira': {'report_label': '28 Days Before Primary filing',
                      'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                      'source_note': "Built from Zakary Pereira's Rhode Island 28 Days Before Primary campaign finance "
                                     'filing supplied by the user.',
                      'coverage_note': 'This is a 28 Days Before Primary filing rather than a Q2 quarterly filing, so '
                                       'it is not directly comparable with candidates whose main display covers April '
                                       '1 through June 30.',
                      'original_documents': [{'label': '28 Days Before Primary 2026 CF-2 report',
                                              'period': 'June 22, 2026 to August 11, 2026',
                                              'href': '/data/finance-documents/zakary-j-pereira-28-days-before-primary-2026.pdf'}],
                      'beginning_cash': 0.0,
                      'money_raised': 12970.0,
                      'money_spent': 7677.1,
                      'ending_cash': 5292.9,
                      'net_change': 5292.9,
                      'total_cash_receipts': 12970.0,
                      'campaign_expenses': 7677.1,
                      'aggregate_expenses': 0.0,
                      'summary_intro': "Zakary J Pereira's 28 Days Before Primary filing reports $12,970.00 in total "
                                       'cash received, including $3,000.00 in loan proceeds, $7,677.10 in campaign '
                                       'expenses, and $5,292.90 in cash on hand.',
                      'filing_history': [{'label': '28 Days Before Primary 2026',
                                          'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                                          'money_raised': 12970.0,
                                          'money_spent': 7677.1,
                      ...
                      'source_buckets': [{'label': 'Itemized individual donors',
                                         ...
                                         {'label': 'PAC contributions',
                                          'class_name': 'pac-contributions',
                                          'amount': 4800.0,
                                          'description': 'Political action committee contributions reported in the '
                                                         'pre-primary filing.'},
                                         {'label': 'Candidate loan',
                                          'class_name': 'candidate-loan',
                                          'amount': 3000.0,
                                          'description': 'Loan proceeds from Zakary Pereira to the campaign.'}],
                      'top_donors': [{'donor': 'Zakary Pereira',
                                      'amount': 3000.0,
                                      'type': 'Loan Proceeds',
                                      'interest_group': 'Other / Unclassified',
                                      'notes': 'Candidate loan proceeds reported in the filing.'},
                                     {'donor': 'DISTRICT 1199 SEIU POLITICAL ACTION COMMITTEE-RI',
                                      'amount': 2000.0,
                                      'type': 'PAC',
                                      'interest_group': 'Other / Unclassified',
                                      'notes': 'Named contribution listed in the filing.'},
                                     {'donor': 'Matthew Gunnip',
                                      'amount': 2000.0,
                                      'type': 'Individual',
                                      'interest_group': 'Individual',
                                      'notes': 'Employer listed as State of RI.'},
                                     {'donor': 'RI ALLIANCE SSE SEIU COPE (Social Service Employees)',
                                      'amount': 2000.0,
                                      'type': 'PAC',
                                      'interest_group': 'Labor / Unions',
                                      'notes': 'Named contribution listed in the filing.'},
                                     {'donor': 'Aaron Buongiovanni',
                                      'amount': 500.0,
                                      'type': 'Individual',
                                      'interest_group': 'Individual',
                                      'notes': 'Employer listed as Innovative Renal Care.'},
                                     {'donor': 'Lisa Pereira',
                                      'amount': 500.0,
                                      'type': 'Individual',
                                      'interest_group': 'Individual',
                                      'notes': 'Employer listed as retired.'},
                                     {'donor': 'NEARI PACE (National Education Association of RI)',
                                      'amount': 500.0,
                                      'type': 'PAC',
                                      'interest_group': 'Education',
                                      'notes': 'Named contribution listed in the filing.'},
                                     {'donor': 'Meredith Armstrong',
                                      'amount': 250.0,
                                      'type': 'Individual',
                                      'interest_group': 'Individual',
                                      'notes': 'Employer listed as State of RI.'},
                                     {'donor': 'Rebecca Kislak',
                                      'amount': 250.0,
                                      'type': 'Individual',
                                      'interest_group': 'Individual',
                                      'notes': 'Employer listed as Legal Key.'},
                                     {'donor': 'RI WORKING FAMILIES PARTY PAC',
                                      'amount': 200.0,
                                      'type': 'PAC',
                                      'interest_group': 'Other / Unclassified',
                                     ...
                                     {'donor': 'RI BROTHERHOOD OF CORRECTIONAL OFFICERS PAC',
                                      ...
                                      'notes': 'Named contribution listed in the filing.'}],
                      'spending_categories': [{'title': 'Advertising',
                                               'summary': 'Visible spending includes BrandX360, Canva, and Wix.',
                                               'amount': 5755.06},
                                              {'title': 'Other',
                                               'summary': 'Visible spending includes Campaign Verify and Rhode Island '
                      ...
                      'explainer_cards': [],
                      'finance_status': 'available_preprimary'},
 'angela-s-coburn': {'report_label': 'Q2 2026 campaign finance filing',
                     'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                     'source_note': "Built from Angela S Coburn's Rhode Island Q1 and Q2 2026 campaign finance filings "
                                    'supplied by the user.',
                     'coverage_note': 'Q2 is the standardized main display. No contributions were reported in Q1 or '
                                      'Q2.',
                     'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                             'period': 'January 1, 2026 to March 31, 2026',
                                             'href': '/data/finance-documents/angela-s-coburn-q1-2026.pdf'},
                                            {'label': 'Q2 2026 CF-2 report',
                                             'period': 'April 1, 2026 to June 30, 2026',
                                             'href': '/data/finance-documents/angela-s-coburn-q2-2026.pdf'}],
                     'beginning_cash': 2145.0,
                     'money_raised': 0.0,
                     'money_spent': 900.0,
                     'ending_cash': 1245.0,
                     'net_change': -900.0,
                     'total_cash_receipts': 0.0,
                     'campaign_expenses': 900.0,
                     'aggregate_expenses': 0.0,
                     'summary_intro': "Angela S Coburn's Q2 2026 filing reports no new receipts, $900.00 in campaign "
                                      'expenses, and $1,245.00 in cash on hand.',
                     'filing_history': [{'label': 'Q1 2026',
                                         'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                         'money_raised': 0.0,
                                         'money_spent': 0.0,
                                         'ending_cash': 2145.0,
                                         'net_change': 0.0,
                                         'notes': 'Q1 reported no receipts or spending.'},
                                        {'label': 'Q2 2026',
                                         'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                         'money_raised': 0.0,
                                         'money_spent': 900.0,
                     ...
                     'top_donors': [],
                     'spending_categories': [{'title': 'Advertising',
                                              'summary': 'Visible spending includes WWWAAA.',
                                              'amount': 800.0},
                                             {'title': 'Donations (All Others)',
                                              'summary': 'Visible spending includes Friends of Kevin Millonzi.',
                                              'amount': 100.0}],
                     'takeaways': [],
                     'explainer_cards': [],
                     'finance_status': 'available'},
 'sherry-l-roberts': {'report_label': 'Q2 2026 campaign finance filing',
                      'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                      'source_note': "Built from Sherry L Roberts's Rhode Island Q1 and Q2 2026 campaign finance "
                                     'filings supplied by the user.',
                      'coverage_note': 'Q2 is the standardized main display. Q1 contained a $500 contribution from '
                                       'REALTORS PAC OF RI; Q2 reported no new receipts or spending.',
                      'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                              'period': 'January 1, 2026 to March 31, 2026',
                                              'href': '/data/finance-documents/sherry-l-roberts-q1-2026.pdf'},
                                             {'label': 'Q2 2026 CF-2 report',
                                              'period': 'April 1, 2026 to June 30, 2026',
                                              'href': '/data/finance-documents/sherry-l-roberts-q2-2026.pdf'}],
                      'beginning_cash': 4555.21,
                      'money_raised': 0.0,
                      'money_spent': 0.0,
                      'ending_cash': 4555.21,
                      'net_change': 0.0,
                      ...
                      'campaign_expenses': 0.0,
                      'aggregate_expenses': 0.0,
                      'summary_intro': "Sherry L Roberts's Q2 2026 filing reports no new receipts or spending and an "
                                       'ending cash balance of $4,555.21. Her Q1 filing reported a $500 contribution '
                                       'from REALTORS PAC OF RI.',
                      'filing_history': [{'label': 'Q1 2026',
                                          'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                          'money_raised': 500.0,
                                          'money_spent': 0.0,
                                          'ending_cash': 4555.21,
                                          'net_change': 500.0,
                                          'notes': 'Q1 reported a $500 PAC contribution from REALTORS PAC OF RI.'},
                                         {'label': 'Q2 2026',
                                          'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                          'money_raised': 0.0,
                                          'money_spent': 0.0,
                                          'ending_cash': 4555.21,
                                          'net_change': 0.0,
                                          'notes': 'Q2 is the standardized main display period and reported no new '
                                                   'activity.'}],
                      'source_buckets': [],
                      'top_donors': [],
                      'spending_categories': [],
                      ...
                      'explainer_cards': [],
                      'finance_status': 'available'},
 'james-c-sheehan': {'report_label': 'Q2 2026 campaign finance filing',
                     'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                     'source_note': "Built from James C Sheehan's Rhode Island Q1 and Q2 2026 campaign finance filings "
                                    'supplied by the user.',
                     'coverage_note': 'Q2 is the standardized main display. The Q2 filing reports a $1,000 candidate '
                                      'loan in addition to a $2,000 individual contribution.',
                     'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                             'period': 'January 1, 2026 to March 31, 2026',
                                             'href': '/data/finance-documents/james-c-sheehan-q1-2026.pdf'},
                                            {'label': 'Q2 2026 CF-2 report',
                                             'period': 'April 1, 2026 to June 30, 2026',
                                             'href': '/data/finance-documents/james-c-sheehan-q2-2026.pdf'}],
                     'beginning_cash': 0.0,
                     'money_raised': 3000.0,
                     'money_spent': 293.15,
                     'ending_cash': 2706.85,
                     'net_change': 2706.85,
                     'total_cash_receipts': 3000.0,
                     'campaign_expenses': 293.15,
                     'aggregate_expenses': 0.0,
                     'summary_intro': "James C Sheehan's Q2 2026 filing reports $3,000.00 in total cash received, "
                                      'including a $1,000.00 candidate loan, $293.15 in campaign expenses, and '
                                      '$2,706.85 in cash on hand.',
                     'filing_history': [{'label': 'Q1 2026',
                                         'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                         'money_raised': 0.0,
                                         'money_spent': 0.0,
                                         'ending_cash': 0.0,
                                         'net_change': 0.0,
                                         'notes': 'Q1 reported no cash activity.'},
                                        {'label': 'Q2 2026',
                                         'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                         'money_raised': 3000.0,
                                         'money_spent': 293.15,
                     ...
                     'source_buckets': [{'label': 'Itemized individual donors',
                                         'class_name': 'itemized-individual-donors',
                                         'amount': 2000.0,
                                         'description': 'Named individual contribution reported in Q2.'},
                                        {'label': 'Candidate loan',
                                         'class_name': 'candidate-loan',
                                         'amount': 1000.0,
                                         'description': 'Loan proceeds from James C Sheehan to the campaign.'}],
                     'top_donors': [{'donor': 'Julie Casimiro',
                                     'amount': 2000.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as retired.'},
                                    {'donor': 'James C Sheehan',
                                     'amount': 1000.0,
                                     'type': 'Loan Proceeds',
                                     'interest_group': 'Other / Unclassified',
                                     'notes': 'Candidate loan proceeds reported in the filing.'}],
                     'spending_categories': [{'title': 'Other',
                                              'summary': 'Visible spending includes OpenAI ChatGPT and Sign Rocket.',
                                              'amount': 262.65},
                                             {'title': 'Bank Fees',
                                              'summary': 'Visible spending includes Citizens Bank.',
                                              'amount': 30.5}],
...
def apply_pereira_coburn_roberts_sheehan_overrides(profile: dict[str, object]) -> dict[str, object]:
    override = PEREIRA_COBURN_ROBERTS_SHEEHAN_OVERRIDES.get(str(profile.get("slug", "")))
    if not override:
        return profile
    profile.update(override)
    return profile
...
MCCOY_MENEC_STANTON_KENNEDY_MOFFITT_OVERRIDES = {'matthew-b-mccoy': {'report_label': 'Q2 2026 campaign finance filing',
                     'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                     'source_note': "Built from Matthew B McCoy's Rhode Island Q1 and Q2 2026 campaign finance filings "
                                    'supplied by the user.',
                     'coverage_note': 'Q2 is the standardized main display. The Q2 filing reports a $400 candidate '
                                      'loan and a $100 individual contribution. Q1 is retained in filing history.',
                     'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                             'period': 'January 1, 2026 to March 31, 2026',
                                             'href': '/data/finance-documents/matthew-b-mccoy-q1-2026.pdf'},
                                            {'label': 'Q2 2026 CF-2 report',
                                             'period': 'April 1, 2026 to June 30, 2026',
                                             'href': '/data/finance-documents/matthew-b-mccoy-q2-2026.pdf'}],
                     'beginning_cash': 0.0,
                     'money_raised': 500.0,
                     'money_spent': 0.0,
                     'ending_cash': 500.0,
                     'net_change': 500.0,
                     'total_cash_receipts': 500.0,
                     'campaign_expenses': 0.0,
                     'aggregate_expenses': 0.0,
                     'summary_intro': "Matthew B McCoy's Q2 2026 filing reports $500.00 in total cash received, "
                                      'including a $400.00 candidate loan and a $100.00 individual contribution, no '
                                      'campaign expenses, and $500.00 in cash on hand.',
                     'filing_history': [{'label': 'Q1 2026',
                                         'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                         'money_raised': 0.0,
                                         'money_spent': 475.53,
                                         'ending_cash': 0.0,
                                         'net_change': -475.53,
                                         'notes': 'Q1 reported $475.53 in campaign expenses and no new receipts.'},
                                        {'label': 'Q2 2026',
                                         'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                         'money_raised': 500.0,
                                         'money_spent': 0.0,
                     ...
                     'source_buckets': [{'label': 'Itemized individual donors',
                                         'class_name': 'itemized-individual-donors',
                                         'amount': 100.0,
                                         'description': 'Named individual cash contribution reported in Q2.'},
                                        {'label': 'Candidate loan',
                                         'class_name': 'candidate-loan',
                                         'amount': 400.0,
                                         'description': 'Loan proceeds from Matthew B McCoy to the campaign.'}],
                     'top_donors': [{'donor': 'Matthew B McCoy',
                                     'amount': 400.0,
                                     'type': 'Loan Proceeds',
                                     'interest_group': 'Other / Unclassified',
                                     'notes': 'Candidate loan proceeds reported in the filing.'},
                                    {'donor': 'Michael J Donohue',
                                     'amount': 100.0,
                                     'type': 'Individual',
                                     'interest_group': 'Individual',
                                     'notes': 'Employer listed as retired.'}],
                     ...
                     'explainer_cards': [],
                     'finance_status': 'available'},
 'thomas-n-menec': {'report_label': 'Q2 2026 campaign finance filing',
                    'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                    'source_note': "Built from Thomas N Menec's Rhode Island Q2 2026 campaign finance filing supplied "
                                   'by the user.',
                    'coverage_note': 'Q2 is the standardized main display. The filing reports $4,450 in individual '
                                     'contributions and a $100 candidate loan.',
                    'original_documents': [{'label': 'Q2 2026 CF-2 report',
                                            'period': 'April 1, 2026 to June 30, 2026',
                                            'href': '/data/finance-documents/thomas-n-menec-q2-2026.pdf'}],
                    'beginning_cash': 0.0,
                    'money_raised': 4550.0,
                    'money_spent': 1839.03,
                    'ending_cash': 2710.97,
                    'net_change': 2710.97,
                    'total_cash_receipts': 4550.0,
                    'campaign_expenses': 1839.03,
                    'aggregate_expenses': 0.0,
                    'summary_intro': "Thomas N Menec's Q2 2026 filing reports $4,550.00 in total cash received, "
                                     'including a $100.00 candidate loan, $1,839.03 in campaign expenses, and '
                                     '$2,710.97 in cash on hand.',
                    'filing_history': [{'label': 'Q2 2026',
                                        'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                        'money_raised': 4550.0,
                                        'money_spent': 1839.03,
                    ...
                    'source_buckets': [{'label': 'Itemized individual donors',
                                       ...
                                       {'label': 'Candidate loan',
                                        'class_name': 'candidate-loan',
                                        'amount': 100.0,
                                        'description': 'Loan proceeds from Thomas N Menec to the campaign.'}],
                    'top_donors': [{'donor': 'Joseph R Vinagro',
                                    'amount': 2000.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                   ...
                                   {'donor': 'James Grundy',
                                    ...
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Atlantic Controls.'},
                                   {'donor': 'Joy B Santilli',
                                    'amount': 500.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Named contribution listed in the filing.'},
                                   {'donor': 'Michael R Martone',
                                    'amount': 500.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Named contribution listed in the filing.'},
                                   {'donor': 'John J Kupa',
                                    ...
                                    'interest_group': 'Individual',
                                    'notes': 'Named contribution listed in the filing.'},
                                   {'donor': 'Geoffrey R Morrow',
                                    'amount': 200.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Named contribution listed in the filing.'},
                                   {'donor': 'Thomas N Menec',
                                    'amount': 100.0,
                                    'type': 'Loan Proceeds',
                                    'interest_group': 'Other / Unclassified',
                                    'notes': 'Candidate loan proceeds reported in the filing.'}],
                    'spending_categories': [{'title': 'Advertising',
                                             'summary': 'Visible spending includes Brand X360 and Good Guys Signs.',
                                             'amount': 1803.23},
                                            {'title': 'Bank Fees',
                                             'summary': 'Visible spending includes Harland Clark.',
                                             'amount': 35.8}],
                    'takeaways': [],
                    'explainer_cards': [],
                    'finance_status': 'available'},
 'christopher-m-stanton': {'report_label': 'No financial summary details found',
                           'reporting_period_label': '',
                           'source_note': 'No financial summary details were supplied for this candidate in the '
                                          'current batch.',
                           'coverage_note': 'No financial summary details found. Zeroes should not be interpreted as '
                           ...
                           'explainer_cards': [],
                           'finance_status': 'not_found'},
 'brian-patrick-kennedy': {'report_label': 'Q2 2026 campaign finance filing',
                           'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                           'source_note': "Built from Brian Patrick Kennedy's Rhode Island Q1 and Q2 2026 campaign "
                                          'finance filings supplied by the user.',
                           'coverage_note': 'Q2 is the standardized main display. Total cash receipts include $6,175 '
                                            'in individual contributions, $3,075 in PAC contributions, and $6,401.46 '
                                            'in refunds/rebates.',
                           'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                                   'period': 'January 1, 2026 to March 31, 2026',
                                                   'href': '/data/finance-documents/brian-patrick-kennedy-q1-2026.pdf'},
                                                  {'label': 'Q2 2026 CF-2 report',
                                                   'period': 'April 1, 2026 to June 30, 2026',
                                                   'href': '/data/finance-documents/brian-patrick-kennedy-q2-2026.pdf'}],
                           'beginning_cash': 59514.88,
                           'money_raised': 15651.46,
                           'money_spent': 7553.37,
                           'ending_cash': 67612.97,
                           'net_change': 8098.09,
                           'total_cash_receipts': 15651.46,
                           'campaign_expenses': 7553.37,
                           'aggregate_expenses': 0.0,
                           'summary_intro': "Brian Patrick Kennedy's Q2 2026 filing reports $15,651.46 in total cash "
                                            'receipts, $7,553.37 in campaign expenses, and $67,612.97 in cash on hand. '
                                            'Receipts include $6,401.46 in refunds and rebates.',
                           'filing_history': [{'label': 'Q1 2026',
                                               'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                               'money_raised': 8457.63,
                                               'money_spent': 8550.31,
                                               'ending_cash': 59514.88,
                                               'net_change': -92.68,
                                               'notes': 'Q1 receipts included $7,457.63 in refunds/rebates.'},
                                              {'label': 'Q2 2026',
                                               'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                               'money_raised': 15651.46,
                                               'money_spent': 7553.37,
                           ...
                           'source_buckets': [{'label': 'Itemized individual donors',
                                              ...
                                              {'label': 'PAC contributions',
                                               ...
                                               'description': 'Political action committee contributions reported in '
                                                              'Q2.'},
                                              {'label': 'Refunds / rebates',
                                               'class_name': 'other-receipts',
                                               'amount': 6401.46,
                                               'description': 'Expense reimbursements and other refunds/rebates '
                                                              'reported in Q2.'}],
                           'top_donors': [{'donor': 'John H Petrarca',
                                           'amount': 1000.0,
                                           'type': 'Individual',
                                           'interest_group': 'Individual',
                                           'notes': 'Employer listed as Providence Auto Body Inc.'},
                                          {'donor': 'REALTORS PAC OF RI',
                                           'amount': 500.0,
                                           'type': 'PAC',
                                           'interest_group': 'Housing / Real Estate',
                                           'notes': 'Named contribution listed in the filing.'},
                                          {'donor': 'M Christine Benoit',
                                           'amount': 400.0,
                                           'type': 'Individual',
                                           'interest_group': 'Individual',
                                           'notes': 'Employer listed as Dr. M Christine Benoit, DMD.'},
                                          {'donor': 'William J Murphy',
                                           'amount': 350.0,
                                           'type': 'Individual',
                                           'interest_group': 'Individual',
                                           'notes': 'Employer listed as Dome Consultants LLC.'},
                                          {'donor': 'Andrew C Rogers',
                                           'amount': 300.0,
                                           'type': 'Individual',
                                           'interest_group': 'Individual',
                                           'notes': 'Employer listed as Westerly Community Credit Union.'},
                                          {'donor': 'RHODE ISLAND ENERGY PAC (RIE PAC)',
                                           'amount': 300.0,
                                           'type': 'PAC',
                                           'interest_group': 'Energy / Utilities',
                                           'notes': 'Named contribution listed in the filing.'},
                                          {'donor': 'INDEPENDENT INSURANCE AGENTS RI PAC',
                                           'amount': 250.0,
                                           'type': 'PAC',
                                           'interest_group': 'Finance / Insurance',
                                           'notes': 'Named contribution listed in the filing.'}],
                           'spending_categories': [{'title': 'Travel & Lodging',
                                                    'summary': 'Visible spending includes American Airlines, Delta '
                                                               'Airlines, hotels, parking, rideshare, and transit.',
                                                    'amount': 5624.6},
                                                   {'title': 'Other',
                                                    'summary': 'Visible spending includes State Legislative Leaders '
                                                               'Foundation and U.S. Postal Service.',
                                                    'amount': 788.0},
                                                   {'title': 'Fundraising Expenses',
                                                    'summary': "Visible spending includes BJ's Wholesale Club, "
                                                               "Camille's, Dollar Tree, and Minuteman Press.",
                                                    'amount': 694.35},
                                                   {'title': 'Telephone',
                                                    'summary': 'Visible spending includes T-Mobile.',
                                                    'amount': 246.42},
                                                   {'title': 'Donations (Political)',
                                                    'summary': 'Visible spending includes Friends of Gregg Amore and '
                                                               'Hopkinton Democratic Town Committee.',
                                                    'amount': 200.0}],
                           'takeaways': [],
                           'explainer_cards': [],
                           'finance_status': 'available'},
 'stephen-c-moffitt': {'report_label': 'No financial summary details found',
                       'reporting_period_label': '',
                       'source_note': 'No financial summary details were supplied for this candidate in the current '
                                      'batch.',
                       'coverage_note': 'No financial summary details found. Zeroes should not be interpreted as '
                                        'reported campaign activity.',
                       'original_documents': [],
...
def apply_mccoy_menec_stanton_kennedy_moffitt_overrides(profile: dict[str, object]) -> dict[str, object]:
    override = MCCOY_MENEC_STANTON_KENNEDY_MOFFITT_OVERRIDES.get(str(profile.get("slug", "")))
    if not override:
        return profile
    profile.update(override)
    return profile
...
RILEY_STRAVATO_MARSZALKOWSKI_SANDOVAL_THEROUX_WOSENCROFT_JARVAIS_OVERRIDES = {'michael-j-riley': {'report_label': '2019 On-Going Quarterly (3rd) filing',
                     'reporting_period_label': 'Period ending September 30, 2019',
                     'source_note': 'Historical campaign-finance summary supplied by the user. No 2026 financial '
                                    'summary was provided for this update.',
                     'coverage_note': 'Historical data only. This filing is from 2019 and should not be compared '
                                      'directly with 2026 candidate filings.',
                     'original_documents': [],
                     'beginning_cash': 0.0,
                     'money_raised': 0.0,
                     'money_spent': 0.0,
                     ...
                     'campaign_expenses': 0.0,
                     'aggregate_expenses': 0.0,
                     'summary_intro': 'The latest financial summary supplied for Michael J Riley is historical: a 2019 '
                                      'On-Going Quarterly (3rd) filing with a period end date of September 30, 2019. '
                                      'It reports $0.00 total cash, $0.00 total liabilities, a $0.00 beginning '
                                      'balance, and a $0.00 ending balance.',
                     'filing_history': [{'label': '2019 On-Going Quarterly (3rd)',
                                         'reporting_period_label': 'Period ending September 30, 2019',
                                         'money_raised': 0.0,
                                         'money_spent': 0.0,
                                         'ending_cash': 0.0,
                                         'net_change': 0.0,
                                         'notes': 'Historical filing only; no 2026 financial summary supplied.'}],
                     'source_buckets': [],
                     'top_donors': [],
                     'spending_categories': [],
                     'takeaways': [],
                     'explainer_cards': [],
                     'finance_status': 'available_historical'},
 'edward-w-stravato': {'report_label': 'Q2 2026 campaign finance filing',
                       'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                       'source_note': "Built from Edward William Stravato's Rhode Island Q2 2026 campaign finance "
                                      'filing supplied by the user.',
                       'coverage_note': 'Q2 is the standardized main display. Total cash receipts include a $50,000 '
                                        'candidate loan and $275 in individual contributions.',
                       'original_documents': [{'label': 'Q2 2026 CF-2 report',
                                               'period': 'April 1, 2026 to June 30, 2026',
                                               'href': '/data/finance-documents/edward-w-stravato-q2-2026.pdf'}],
                       'beginning_cash': 0.0,
                       'money_raised': 50275.0,
                       'money_spent': 4550.3,
                       'ending_cash': 45724.7,
                       'net_change': 45724.7,
                       'total_cash_receipts': 50275.0,
                       'campaign_expenses': 4550.3,
                       'aggregate_expenses': 0.0,
                       'summary_intro': "Edward W Stravato's Q2 2026 filing reports $50,275.00 in total cash received, "
                                        'including a $50,000.00 candidate loan, $4,550.30 in campaign expenses, and '
                                        '$45,724.70 in cash on hand.',
                       'filing_history': [{'label': 'Q2 2026',
                                           'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                           'money_raised': 50275.0,
                                           'money_spent': 4550.3,
                       ...
                       'source_buckets': [{'label': 'Itemized individual donors',
                                          ...
                                          {'label': 'Candidate loan',
                                           'class_name': 'candidate-loan',
                                           'amount': 50000.0,
                                           'description': 'Loan proceeds from Edward W Stravato to the campaign.'}],
                       'top_donors': [{'donor': 'Edward W Stravato',
                                       'amount': 50000.0,
                                       'type': 'Loan Proceeds',
                                       'interest_group': 'Other / Unclassified',
                                       'notes': 'Candidate loan proceeds reported in the filing.'},
                                      {'donor': 'William Bennell',
                                       'amount': 125.0,
                                       'type': 'Individual',
                                       'interest_group': 'Individual',
                                       'notes': 'Employer listed as Federal Hill Signs.'},
                                      {'donor': 'Jason Lampert',
                                       'amount': 100.0,
                                       'type': 'Individual',
                                       'interest_group': 'Individual',
                                       'notes': 'Employer listed as Salzano Ettinger Lampert.'},
                                      {'donor': 'Casey Perry',
                                       'amount': 50.0,
                                       'type': 'Individual',
                                       'interest_group': 'Individual',
                                       'notes': 'Employer listed as Summit Settlement.'}],
                       'spending_categories': [{'title': 'Advertising',
                                                'summary': 'Visible spending includes 4Imprint Inc., GoDaddy.com, HUB '
                                                           'Federal Signs, Makestickers.com, and Pens.com.',
                                                'amount': 4390.23},
                                               {'title': 'Office Equipment & Supplies',
                                                'summary': 'Visible spending includes Walmart.',
                                                'amount': 134.81},
                                               {'title': 'Food, Beverages and Meals',
                                                'summary': 'Visible spending includes Market Basket.',
                                                'amount': 19.92},
                       ...
                       'explainer_cards': [],
                       'finance_status': 'available'},
 'alex-d-marszalkowski': {'report_label': 'Q2 2026 campaign finance filing',
                          'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                          'source_note': "Built from Alex D Marszalkowski's Rhode Island Q1 and Q2 2026 campaign "
                                         'finance filings supplied by the user.',
                          'coverage_note': 'Q2 is the standardized main display. Q2 reports no new receipts and '
                                           '$329.24 in aggregate expenditures. Q1 is retained in filing history.',
                          'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                                  'period': 'January 1, 2026 to March 31, 2026',
                                                  'href': '/data/finance-documents/alex-d-marszalkowski-q1-2026.pdf'},
                                                 {'label': 'Q2 2026 CF-2 report',
                                                  'period': 'April 1, 2026 to June 30, 2026',
                                                  'href': '/data/finance-documents/alex-d-marszalkowski-q2-2026.pdf'}],
                          'beginning_cash': 18010.04,
                          'money_raised': 0.0,
                          'money_spent': 329.24,
                          'ending_cash': 17680.8,
                          'net_change': -329.24,
                          'total_cash_receipts': 0.0,
                          'campaign_expenses': 0.0,
                          'aggregate_expenses': 329.24,
                          'summary_intro': "Alex D Marszalkowski's Q2 2026 filing reports no new cash receipts, "
                                           '$329.24 in aggregate expenditures, and $17,680.80 in cash on hand.',
                          'filing_history': [{'label': 'Q1 2026',
                                              'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                              'money_raised': 100.0,
                                              'money_spent': 0.0,
                                              'ending_cash': 18010.04,
                                              'net_change': 100.0,
                                              'notes': 'Q1 reported $100.00 in aggregate individual receipts.'},
                                             {'label': 'Q2 2026',
                                              'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                              'money_raised': 0.0,
                                              'money_spent': 329.24,
                          ...
                          'top_donors': [],
                          'spending_categories': [{'title': 'Donations (All Others)',
                                                   'summary': 'Aggregate expenditures reported without individual '
                                                              'payee names.',
                                                   'amount': 306.05},
                                                  {'title': 'Advertising',
                                                   'summary': 'Aggregate advertising expenditure reported without an '
                                                              'individual payee name.',
                                                   'amount': 23.19}],
                          'takeaways': [],
                          'explainer_cards': [],
                          'finance_status': 'available'},
 'luis-ernesto-sandoval-jr': {'report_label': 'Q1 2026 campaign finance filing',
                              'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                              'source_note': "Built from Luis Sandoval's Rhode Island Q1 2026 campaign finance filing "
                                             'supplied by the user.',
                              'coverage_note': 'Only a Q1 2026 filing was supplied for this candidate. It should not '
                                               'be directly compared with candidates displayed using Q2 filings.',
                              'original_documents': [{'label': 'Q1 2026 CF-2 report',
                                                      'period': 'January 1, 2026 to March 31, 2026',
                                                      'href': '/data/finance-documents/luis-ernesto-sandoval-jr-q1-2026.pdf'}],
                              'beginning_cash': 0.0,
                              'money_raised': 10.0,
                              'money_spent': 0.0,
                              'ending_cash': 10.0,
                              'net_change': 10.0,
                              'total_cash_receipts': 10.0,
                              'campaign_expenses': 0.0,
                              'aggregate_expenses': 0.0,
                              'summary_intro': "Luis Ernesto Sandoval Jr's Q1 2026 filing reports a $10.00 individual "
                                               'contribution, no spending, and $10.00 in cash on hand.',
                              'filing_history': [{'label': 'Q1 2026',
                                                  'reporting_period_label': 'January 1, 2026 to March 31, 2026',
                                                  'money_raised': 10.0,
                                                  'money_spent': 0.0,
                                                  'ending_cash': 10.0,
                                                  'net_change': 10.0,
                                                  'notes': 'Only Q1 data is available in this update.'}],
                              'source_buckets': [{'label': 'Itemized individual donors',
                                                  'class_name': 'itemized-individual-donors',
                                                  'amount': 10.0,
                                                  'description': 'Named individual cash contribution reported in Q1.'}],
                              'top_donors': [{'donor': 'Luis Sandoval',
                                              'amount': 10.0,
                                              'type': 'Individual',
                                              'interest_group': 'Individual',
                                              'notes': 'Candidate contribution reported in the filing.'}],
                              'spending_categories': [],
                              'takeaways': [],
                              'explainer_cards': [],
                              'finance_status': 'available_q1_only'},
 'mark-a-theroux': {'report_label': '28 Days Before Primary filing',
                    'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                    'source_note': "Built from Mark A Theroux's Rhode Island 28 Days Before Primary campaign finance "
                                   'filing supplied by the user.',
                    'coverage_note': 'This is a 28 Days Before Primary filing rather than a Q2 quarterly filing, so it '
                                     'is not directly comparable with candidates whose main display covers April 1 '
                                     'through June 30.',
                    'original_documents': [{'label': '28 Days Before Primary 2026 CF-2 report',
                                            'period': 'June 22, 2026 to August 11, 2026',
                                            'href': '/data/finance-documents/mark-a-theroux-28-days-before-primary-2026.pdf'}],
                    'beginning_cash': 0.0,
                    'money_raised': 9530.0,
                    'money_spent': 2150.4,
                    'ending_cash': 7379.6,
                    'net_change': 7379.6,
                    'total_cash_receipts': 9530.0,
                    'campaign_expenses': 2150.4,
                    'aggregate_expenses': 0.0,
                    'summary_intro': "Mark A Theroux's 28 Days Before Primary filing reports $9,530.00 in total cash "
                                     'received, including $2,500.00 in candidate loan proceeds, $2,150.40 in campaign '
                                     'expenses, and $7,379.60 in cash on hand.',
                    'filing_history': [{'label': '28 Days Before Primary 2026',
                                        'reporting_period_label': 'June 22, 2026 to August 11, 2026',
                                        'money_raised': 9530.0,
                                        'money_spent': 2150.4,
                    ...
                    'source_buckets': [{'label': 'Itemized individual donors',
                                       ...
                                       {'label': 'PAC contributions',
                                        'class_name': 'pac-contributions',
                                        'amount': 200.0,
                                        'description': 'Aggregate PAC receipts reported without a committee name.'},
                                       {'label': 'Candidate loan',
                                        'class_name': 'candidate-loan',
                                        'amount': 2500.0,
                                        'description': 'Loan proceeds from Mark Theroux to the campaign.'}],
                    'top_donors': [{'donor': 'Mark Theroux',
                                    'amount': 2500.0,
                                    'type': 'Loan Proceeds',
                                    'interest_group': 'Other / Unclassified',
                                    'notes': 'Candidate loan proceeds reported in the filing.'},
                                   ...
                                   {'donor': 'John Lynch',
                                    ...
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Northeaster Tree.'},
                                   {'donor': 'Jeffrey Bent',
                                    'amount': 300.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as Providence Housing Authority.'},
                                   {'donor': 'Edward Cotugno',
                                    'amount': 300.0,
                                    'type': 'Individual',
                                    'interest_group': 'Individual',
                                    'notes': 'Employer listed as retired.'}],
                    'spending_categories': [{'title': 'Fundraising Expenses',
                                             'summary': 'Visible spending includes 579 and U.S. Postal Service.',
                                             'amount': 1275.4},
                                            {'title': 'Advertising',
                                             'summary': 'Visible spending includes Alexander Gim-Fain, Hanna Pro, and '
                                                        'TrueRad Designs.',
                                             'amount': 875.0}],
                    'takeaways': [],
                    'explainer_cards': [],
                    'finance_status': 'available_preprimary'},
 'grant-webber-wosencroft': {'report_label': 'Q2 2026 campaign finance filing',
                             'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                             'source_note': "Built from Grant Webber Wosencroft's Rhode Island Q2 2026 campaign "
                                            'finance filing supplied by the user.',
                             'coverage_note': 'Q2 is the standardized main display. Total cash receipts include $4,000 '
                                              'in candidate loan proceeds and a $9.44 individual contribution.',
                             'original_documents': [{'label': 'Q2 2026 CF-2 report',
                                                     'period': 'April 1, 2026 to June 30, 2026',
                                                     'href': '/data/finance-documents/grant-webber-wosencroft-q2-2026.pdf'}],
                             'beginning_cash': 0.0,
                             'money_raised': 4009.44,
                             'money_spent': 107.72,
                             'ending_cash': 3901.72,
                             'net_change': 3901.72,
                             'total_cash_receipts': 4009.44,
                             'campaign_expenses': 107.72,
                             'aggregate_expenses': 0.0,
                             'summary_intro': "Grant Webber Wosencroft's Q2 2026 filing reports $4,009.44 in total "
                                              'cash received, including $4,000.00 in candidate loans, $107.72 in '
                                              'campaign expenses, and $3,901.72 in cash on hand.',
                             'filing_history': [{'label': 'Q2 2026',
                                                 'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                                 'money_raised': 4009.44,
                                                 'money_spent': 107.72,
                             ...
                             'source_buckets': [{'label': 'Itemized individual donors',
                                                ...
                                                {'label': 'Candidate loan',
                                                 'class_name': 'candidate-loan',
                                                 'amount': 4000.0,
                                                 'description': 'Loan proceeds from Grant Wosencroft to the '
                                                                'campaign.'}],
                             'top_donors': [{'donor': 'Grant W Wosencroft',
                                             'amount': 4000.0,
                                             'type': 'Loan Proceeds',
                                             'interest_group': 'Other / Unclassified',
                                             'notes': 'Candidate loan proceeds reported across three loan '
                                                      'transactions.'},
                                            {'donor': 'Amy Wosencroft',
                                             'amount': 9.44,
                                             'type': 'Individual',
                                             'interest_group': 'Individual',
                                             'notes': 'Employer listed as not employed.'}],
                             'spending_categories': [{'title': 'Other',
                                                      'summary': 'Visible spending includes Automattic Inc. for the '
                                                                 'campaign website domain and account.',
                                                      'amount': 102.72},
                                                     {'title': 'Bank Fees',
                                                      'summary': 'Visible spending includes BankNewport.',
                                                      'amount': 5.0}],
                             'takeaways': [],
                             'explainer_cards': [],
                             'finance_status': 'available'},
 'ronald-paul-jarvais-jr': {'report_label': 'Q2 2026 campaign finance filing',
                            'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                            'source_note': "Built from Ronald Paul Jarvais Jr's Rhode Island Q2 2026 campaign finance "
                                           'filing supplied by the user.',
                            'coverage_note': 'Q2 is the standardized main display. The filing reports only individual '
                                             'cash contributions and no PAC receipts.',
                            'original_documents': [{'label': 'Q2 2026 CF-2 report',
                                                    'period': 'April 1, 2026 to June 30, 2026',
                                                    'href': '/data/finance-documents/ronald-paul-jarvais-jr-q2-2026.pdf'}],
                            'beginning_cash': 0.0,
                            'money_raised': 380.0,
                            'money_spent': 35.49,
                            'ending_cash': 344.51,
                            'net_change': 344.51,
                            'total_cash_receipts': 380.0,
                            'campaign_expenses': 35.49,
                            'aggregate_expenses': 0.0,
                            'summary_intro': "Ronald Paul Jarvais Jr's Q2 2026 filing reports $380.00 in individual "
                                             'contributions, $35.49 in campaign expenses, and $344.51 in cash on hand.',
                            'filing_history': [{'label': 'Q2 2026',
                                                'reporting_period_label': 'April 1, 2026 to June 30, 2026',
                                                'money_raised': 380.0,
                                                'money_spent': 35.49,
                            ...
                            'source_buckets': [{'label': 'Itemized individual donors',
                                                ...
                                                'amount': 380.0,
                                                'description': 'Named individual cash contributions reported in Q2.'}],
                            'top_donors': [{'donor': 'John L Prisco',
                                            'amount': 100.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Four $25 cash contributions reported in the filing.'},
                                           {'donor': 'Deborah Jarvais',
                                            'amount': 50.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Two $25 cash contributions; employer listed as retired.'},
                                           {'donor': 'Larry Sherman',
                                            'amount': 50.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                           ...
                                           {'donor': 'Rick Gregoire',
                                            ...
                                            'interest_group': 'Individual',
                                            'notes': 'Employer listed as retired.'},
                                           {'donor': 'William Gagnon',
                                            'amount': 25.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Named contribution listed in the filing.'},
                                           {'donor': 'Jennifer L Jarvais',
                                            'amount': 25.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Named contribution listed in the filing.'},
                                           ...
                                           {'donor': 'Ron Poulat',
                                            ...
                                            'interest_group': 'Individual',
                                            'notes': 'Employer listed as retired.'},
                                           {'donor': 'Walter Seminick',
                                            'amount': 10.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Employer listed as retired.'},
                                           {'donor': 'Ronald P Jarvais Jr',
                                            'amount': 10.0,
                                            'type': 'Individual',
                                            'interest_group': 'Individual',
                                            'notes': 'Candidate contribution; employer listed as retired.'}],
                            'spending_categories': [{'title': 'Bank Fees',
                                                     'summary': 'Visible spending includes Navigant Credit Union.',
                                                     'amount': 35.49}],
                            'takeaways': [],
                            'explainer_cards': [],
                            'finance_status': 'available'}}
...
def apply_riley_stravato_marszalkowski_sandoval_theroux_wosencroft_jarvais_overrides(profile: dict[str, object]) -> dict[str, object]:
    override = RILEY_STRAVATO_MARSZALKOWSKI_SANDOVAL_THEROUX_WOSENCROFT_JARVAIS_OVERRIDES.get(str(profile.get("slug", "")))
    if not override:
        return profile
    profile.update(override)
    return profile
...
def main() -> int:
    ...
    for index, candidate in enumerate(roster, start=1):
        ...
        if profile:
            ...
            profile = apply_slater_reels_lima_ramos_baret_overrides(profile)
            profile = apply_paplauskas_crudele_segui_overrides(profile)
            profile = apply_pereira_coburn_roberts_sheehan_overrides(profile)
            profile = apply_mccoy_menec_stanton_kennedy_moffitt_overrides(profile)
            profile = apply_riley_stravato_marszalkowski_sandoval_theroux_wosencroft_jarvais_overrides(profile)
